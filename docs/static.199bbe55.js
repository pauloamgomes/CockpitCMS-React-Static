...
function getImageStyleUrl(style, image) {
  console.log(style, image.styles);
  var path = "";
  if (image && image.styles !== undefined) {
    ...
    if (img && img.path) {
      return (Config.WEBSITE_BASE_PATH + "/" + img.path).replace("//", "/").replace("//", "/");
    }
  }
...
var _PostBanner = __webpack_require__(79);

var _PostBanner2 = _interopRequireDefault(_PostBanner);

var _PostComponents = __webpack_require__(81);
...
var _Cta = __webpack_require__(17);
...
var _BrandLogo = __webpack_require__(83);
...
//# sourceMappingURL=static.199bbe55.js.map