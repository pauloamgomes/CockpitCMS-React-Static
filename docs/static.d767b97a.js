...
function getImageStyleUrl(style, image) {
  ...
  if (image && image.styles !== undefined) {
    ...
    if (img && img.path) {
      return ("/" + Config.WEBSITE_BASE_PATH + "/" + Config.COCKPIT_STORAGE_DIR + "/" + img.path).replace("//", "/").replace("//", "/");
    }
  }
  if (image && image.path && !image.path.startsWith(Config.COCKPIT_UPLOADS_DIR)) {
    path = "/" + Config.WEBSITE_BASE_PATH + "/" + Config.COCKPIT_UPLOADS_DIR + "/" + image.path;
  }
...
var _CustomImage = __webpack_require__(16);
...
var _CustomCarousel = __webpack_require__(78);

Object.defineProperty(exports, "CustomCarousel", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_CustomCarousel).default;
  }
});
...
var _cockpit = __webpack_require__(6);
...
var defaultComponents = {
  ...
  button: _cockpit.Button,
  customcarousel: _cockpit.CustomCarousel,
  card: _cockpit.Card
};
...
var COCKPIT_STORAGE_DIR = exports.COCKPIT_STORAGE_DIR = "storage";
...
exports.default = function (_ref) {
  ...
  var Tag = theme === "dark" ? ButtonDarkStyled : ButtonLightStyled;
  return _react2.default.createElement(
    Tag,
...
var _PageComponents = __webpack_require__(8);
...
var _CustomImage = __webpack_require__(42);
...
var _reactPlayer = __webpack_require__(45);
...
var _PostBanner = __webpack_require__(83);

var _PostBanner2 = _interopRequireDefault(_PostBanner);

var _PostComponents = __webpack_require__(85);
...
var _PreviewComponents = __webpack_require__(86);

var _PreviewComponents2 = _interopRequireDefault(_PreviewComponents);
  ...
  _createClass(Preview, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_PreviewComponents2.default, { components: components })
      );
    }
  }]);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 15)), (0, _importCss3.default)('src/pages/Page', {
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/pauloamgomes/Sites/CockpitReactStatic/react-app/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 19)), (0, _importCss3.default)('src/pages/Post', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/pauloamgomes/Sites/CockpitReactStatic/react-app/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 20)), (0, _importCss3.default)('src/pages/Preview', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var transform = {
  ...
  a: function a(node) {
    return _react2.default.createElement(_reactStatic.NavLink, _extends({ to: node.href }, node));
  }
};
...
exports.default = function (_ref) {
  ...
  if (!/^(http)s?:\/\//i.test(src)) {
    src = ("/" + Config.WEBSITE_BASE_PATH + "/" + src).replace("//", "/").replace("//", "/");
  }
...
var _BigHero = __webpack_require__(44);
...
var _PageBanner = __webpack_require__(47);
...
var _SectionDivider = __webpack_require__(49);
...
var _Cta = __webpack_require__(12);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactstrap.Col,
          { sm: "2" },
          _react2.default.createElement(_Cta2.default, { text: linktext, url: linkurl, theme: "dark" })
        )
      )
    )
  );
...
var _BlogCard = __webpack_require__(58);
...
var ContainerStyled = (0, _styledComponents2.default)(_reactstrap.Container)(_templateObject, function (props) {
  ...
  return (0, _utils.getImageStyleUrl)(props.height === "large" ? "PageBannerMedia" : "PageBanner", props.image);
});
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Components2.default, {
            ...
            page: page && page.subpages && page.slug && page.subpages.filter(function (subpage) {
...
exports.default = (0, _reactStatic.withRouteData)(function (_ref) {
  ...
  return _react2.default.createElement(
    ...
    page && page.slug && page.subpages && page.subpages.map(function (subpage, idx) {
      return _react2.default.createElement(
        _reactstrap.NavItem,
        { key: "submenu-" + idx },
        _react2.default.createElement(
...
exports.default = function (_ref) {
  var className = _ref.className,
      text = _ref.text,
      url = _ref.url;
  return _react2.default.createElement(_Cta2.default, { text: text, url: url, theme: className || "light" });
};
...
var _CustomCarousel = __webpack_require__(79);

var _CustomCarousel2 = _interopRequireDefault(_CustomCarousel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _CustomCarousel2.default;
...
var CarouselCaptionStyled = (0, _styledComponents2.default)(_reactstrap.CarouselCaption)(_templateObject);

var CarouselControlStyled = (0, _styledComponents2.default)(_reactstrap.CarouselControl)(_templateObject2);
    ...
    value: function render() {
      ...
      var slides = items.map(function (item, idx) {
        return _react2.default.createElement(
          ...
          item.value && item.value.carousel_image && _react2.default.createElement("img", {
            src: (0, _utils.getImageStyleUrl)("Carousel", item.value.carousel_image),
            alt: item.value.text || ""
          }),
          _react2.default.createElement(CarouselCaptionStyled, {
      ...
      return _react2.default.createElement(
        ...
        slides,
        _react2.default.createElement(CarouselControlStyled, {
          direction: "prev",
...
var CardTextStyled = (0, _styledComponents2.default)(_reactstrap.CardText)(_templateObject2);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        Zoom,
        null,
        card_image && _react2.default.createElement(_reactstrap.CardImg, {
          top: true,
          width: "100%",
          src: (0, _utils.getImageStyleUrl)("Card", card_image),
          alt: title || ""
        })
      ),
      _react2.default.createElement(
        ...
        link_url && _react2.default.createElement(_Cta2.default, { text: link_text, url: link_url, theme: "light" })
      )
    )
  );
};
...
var _BrandLogo = __webpack_require__(88);
...
//# sourceMappingURL=static.d767b97a.js.map